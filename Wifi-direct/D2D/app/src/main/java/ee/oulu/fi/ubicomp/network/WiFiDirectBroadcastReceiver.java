...
import ee.oulu.fi.ubicomp.d2d.D2DWifi;
...
public class WiFiDirectBroadcastReceiver extends BroadcastReceiver {
    ...
    public WiFiDirectBroadcastReceiver(WifiP2pManager manager, WifiP2pManager.Channel channel, D2DWifi activity, WifiP2pManager.PeerListListener mPeerListListener, WifiP2pManager.ConnectionInfoListener mPeerConnectionListener) {
        super();
